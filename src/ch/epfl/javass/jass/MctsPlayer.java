...
public final class MctsPlayer implements Player {
    ...
    public Color chooseTrump(CardSet hand, boolean canPass) { 
        //Question:devrait on rajouter le score?
        long packedHand = hand.packed(); 
        
        final double BREAK_EVEN = 100.46;
        ...
        for(Color c:Color.ALL) {
            ...
            //Ici le score n'importe pas dans les preferences du MCTS
        ...
        return canPass && bestTrumpScore<BREAK_EVEN?null:bestTrump;
    }
