...
public final class GuiTestP1 extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
      ...
      TurnBean trumpB = new TurnBean();
      ArrayBlockingQueue<Card> cardQueue = new ArrayBlockingQueue<>(1);
      ArrayBlockingQueue<Integer> colorQueue = new ArrayBlockingQueue<>(1);

      GraphicalPlayer g =
        new GraphicalPlayer(PlayerId.PLAYER_2, ns, sB, tB, hB,trumpB, cardQueue, colorQueue);
      g.createStage().show();
      ...
      trumpB.setMustChooseTrump(false);
      trumpB.setCanPass(false);
